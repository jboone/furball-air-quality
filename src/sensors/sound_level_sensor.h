...
class SoundLevel_Sensor : public Sensor {
 public:
  SoundLevel_Sensor(uint8_t pin, tick_t update_frequency, uint16_t accuracy, uint16_t precision, boolean calibrated) : Sensor(update_frequency, accuracy, precision, calibrated), _pin(pin) { };
